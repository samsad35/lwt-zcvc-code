...
from une import WavLM, HuBERTEncoder, LibriSpeech
...
def main():
    ...
    hubert_layers = extract_all_layers_latents(hubert, audio_paths, "Extraction HuBERT")
    ...
    plt.title(f"GCCA Similarity: WavLM vs HuBERT ({num_audios} audios LibriSpeech)")
    plt.xlabel("HuBERT Layers")
    plt.ylabel("WavLM Layers")
    
    output_file = output_dir / "gcca_wavlm_hubert_matrix.png"
